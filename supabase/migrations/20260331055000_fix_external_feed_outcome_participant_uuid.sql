    ...
    LOOP
      ...
      IF NOT FOUND THEN
        ...
        VALUES (
          ...
          CASE
            WHEN participant_record.participant_type = 'driver' THEN 'driver'::public.participant_type
            WHEN participant_record.participant_type IN ('team', 'club') THEN 'team'::public.participant_type
            WHEN participant_record.participant_type = 'boolean' THEN 'boolean'::public.participant_type
            ELSE 'custom'::public.participant_type
          END,

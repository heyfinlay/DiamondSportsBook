-- Championship tables & standings views (safe to re-run)
...
DROP POLICY IF EXISTS championship_seasons_admin ON public.championship_seasons;
CREATE POLICY championship_seasons_admin
...
DROP POLICY IF EXISTS championship_seasons_read ON public.championship_seasons;
CREATE POLICY championship_seasons_read
  ON public.championship_seasons
  FOR SELECT
  USING (true);
...
DROP POLICY IF EXISTS championship_teams_admin ON public.championship_teams;
CREATE POLICY championship_teams_admin
...
DROP POLICY IF EXISTS championship_teams_read ON public.championship_teams;
CREATE POLICY championship_teams_read
  ON public.championship_teams
  FOR SELECT
  USING (true);
...
CREATE TABLE IF NOT EXISTS public.championship_drivers (
  ...
  car_number integer,
  status text NOT NULL DEFAULT 'primary' CHECK (status IN ('primary', 'reserve', 'inactive')),
  created_at timestamptz NOT NULL DEFAULT now(),
  updated_at timestamptz NOT NULL DEFAULT now(),
...
DROP POLICY IF EXISTS championship_drivers_admin ON public.championship_drivers;
CREATE POLICY championship_drivers_admin
...
DROP POLICY IF EXISTS championship_drivers_read ON public.championship_drivers;
CREATE POLICY championship_drivers_read
  ON public.championship_drivers
  FOR SELECT
  USING (true);
...
DROP POLICY IF EXISTS championship_races_admin ON public.championship_races;
CREATE POLICY championship_races_admin
...
DROP POLICY IF EXISTS championship_races_read ON public.championship_races;
CREATE POLICY championship_races_read
  ON public.championship_races
  FOR SELECT
  USING (true);
...
DROP POLICY IF EXISTS championship_results_admin ON public.championship_results;
CREATE POLICY championship_results_admin
...
DROP POLICY IF EXISTS championship_results_read ON public.championship_results;
CREATE POLICY championship_results_read
  ON public.championship_results
  FOR SELECT
  USING (true);

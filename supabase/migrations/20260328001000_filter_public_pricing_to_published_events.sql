-- ============================================================================
-- FILTER PUBLIC PRICING TO PUBLISHED EVENTS
-- Prevent draft external events from leaking into public pool pricing helpers.
-- ============================================================================
...
BEGIN
  ...
  WHERE m.archived IS NOT TRUE
    AND COALESCE(e.published, true) IS TRUE
    AND m.status <> 'draft';
END;
$$ LANGUAGE plpgsql
SECURITY DEFINER

...
export function BetSlipDrawer({
  ...
  return (
    <>
      ...
      <aside className={drawerClasses} aria-hidden={!isOpen}>
        <div className="flex h-full flex-col gap-4 px-5 py-4 text-slate-50">
          ...
          {selectedOutcome ? (
            ...
            <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-slate-800 bg-slate-950/40 p-6 text-center text-sm text-slate-400">

...
const AccountPage = () => {
    ...
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs("section", { className: "rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-black/40 p-6 shadow-lg shadow-black/40", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Dashboard" }), _jsxs("div", { className: "mt-3 flex flex-wrap items-start justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-semibold text-white", children: "Account Overview" }), _jsx("p", { className: "text-sm text-white/60", children: "Track your balance, wagers, and requests in one place." })] }), _jsxs("div", { className: "flex flex-col items-end gap-3 sm:flex-row sm:items-center sm:gap-4", children: [_jsx(Link, { to: "/account/settings", className: "rounded-full border border-white/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-white transition hover:border-emerald-400/60 hover:text-white", children: "Account settings" }), _jsxs("div", { className: "rounded-2xl border border-white/20 bg-black/30 px-6 py-4 text-right", children: [_jsxs("p", { className: "text-xs uppercase tracking-[0.35em] text-white/60", children: ["Available ", currencyLabelTitle] }), _jsx("p", { className: "text-3xl font-semibold text-white", children: balanceDisplay })] })] })] })] }), !profileQuery.isLoading && !profileQuery.data?.ic_number && (_jsx("div", { className: "rounded-3xl border border-amber-400/40 bg-amber-500/10 px-5 py-4 text-sm text-amber-100", children: _jsxs("p", { children: ["Add your IC number in", " ", _jsx(Link, { to: "/account/settings", className: "underline", children: "Account Settings" }), " ", "to unlock deposit and withdrawal requests."] }) })), _jsxs("section", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [_jsxs("div", { className: "rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-white", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-white/50", children: "Pending deposits" }), _jsx("p", { className: "mt-1 text-lg font-semibold", children: pendingDeposits.length })] }), _jsxs("div", { className: "rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-white", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-white/50", children: "Pending withdrawals" }), _jsx("p", { className: "mt-1 text-lg font-semibold", children: pendingWithdrawals.length })] }), _jsxs("div", { className: "rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-white", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-white/50", children: "Total wagers" }), _jsx("p", { className: "mt-1 text-lg font-semibold", children: totalWagers })] }), _jsxs("div", { className: "rounded-2xl border border-white/10 bg-black/30 px-4 py-3 text-white", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-white/50", children: "Win / Loss" }), _jsxs("p", { className: "mt-1 text-lg font-semibold", children: [totalWon, " / ", totalLost] })] })] }), _jsxs("div", { className: "grid gap-6 lg:grid-cols-[repeat(3,minmax(0,1fr))]", children: [_jsxs("form", { onSubmit: handleDeposit, className: "rounded-3xl border border-white/10 bg-white/5 p-6 text-white", children: [_jsxs("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: ["Add ", currencyLabelTitle] }), _jsx("h3", { className: "mt-2 text-xl font-semibold", children: "Request Deposit" }), _jsx("p", { className: "text-sm text-white/70", children: "Submit for manual approval. Credits appear once racing ops confirms." }), _jsx("input", { type: "number", min: "1", step: "any", inputMode: "decimal", className: "mt-4 w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-white", value: depositAmount, onChange: (event) => setDepositAmount(event.target.value) }), _jsx("button", { type: "submit", className: "mt-4 w-full rounded-2xl bg-white/90 py-3 text-sm font-semibold uppercase tracking-[0.3em] text-black transition hover:bg-white hover:shadow-[0_0_18px_rgba(255,255,255,0.2)] disabled:opacity-40", disabled: depositMutation.isPending, children: depositMutation.isPending ? "Requesting…" : "Request Deposit" })] }), _jsxs("form", { onSubmit: handleWithdrawal, className: "rounded-3xl border border-white/10 bg-black/40 p-6 text-white", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Cash Out" }), _jsx("h3", { className: "mt-2 text-xl font-semibold", children: "Request Withdrawal" }), _jsx("p", { className: "text-sm text-white/70", children: "Funds are held until administrators complete review." }), _jsx("input", { type: "number", min: "1", step: "any", inputMode: "decimal", className: "mt-4 w-full rounded-2xl border border-white/10 bg-black/60 px-4 py-3 text-white", value: withdrawAmount, onChange: (event) => setWithdrawAmount(event.target.value) }), _jsx("button", { type: "submit", className: "mt-4 w-full rounded-2xl bg-brand py-3 text-sm font-semibold uppercase tracking-[0.3em] text-black transition hover:shadow-[0_0_18px_rgba(16,185,129,0.25)] disabled:opacity-40", disabled: withdrawalMutation.isPending, children: withdrawalMutation.isPending ? "Submitting…" : "Request Withdrawal" })] }), _jsxs("div", { className: "rounded-3xl border border-dashed border-white/15 bg-transparent p-6 text-sm text-white/70", children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Quick Help" }), _jsxs("ul", { className: "mt-3 list-disc space-y-2 pl-5", children: [_jsx("li", { children: "Deposits/withdrawals require approval for compliance." }), _jsxs("li", { children: ["Wagers debit ", currencyLabel, " instantly and appear in the ledger."] }), _jsx("li", { children: "Need help? Ping race control on the admin channel." })] })] })] }), _jsxs("section", { className: "grid gap-6 lg:grid-cols-2", children: [_jsxs("article", { className: "rounded-3xl border border-white/10 bg-black/30 p-6", children: [_jsxs("header", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Ledger" }), _jsx("h2", { className: "text-xl font-semibold text-white", children: "Recent Transactions" })] }), transactionsQuery.isLoading && (_jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-white/40", children: "Syncing\u2026" }))] }), _jsxs("div", { className: "mt-5 space-y-3", children: [transactions.map((tx) => (_jsxs("div", { className: "flex items-center justify-between rounded-2xl border border-white/5 bg-white/5 px-4 py-3", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold capitalize text-white", children: tx.kind }), _jsx("p", { className: "text-xs text-white/60", children: new Date(tx.created_at).toLocaleString() }), renderTransactionNote(tx.meta)] }), _jsxs("p", { className: `text-lg font-semibold ${tx.amount >= 0 ? "text-emerald-300" : "text-white"}`, children: [tx.amount > 0 ? "+" : "", `${currencySymbol}${tx.amount.toFixed(2)}`] })] }, tx.id))), !transactions.length && !transactionsQuery.isLoading && (_jsx("p", { className: "text-sm text-white/60", children: "No transactions yet \u2014 request a deposit or place a wager to see ledger entries." }))] })] }), _jsxs("article", { className: "rounded-3xl border border-white/10 bg-black/30 p-6", children: [_jsxs("header", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Activity" }), _jsx("h2", { className: "text-xl font-semibold text-white", children: "My Wagers" })] }), wagersQuery.isLoading && (_jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-white/40", children: "Loading\u2026" }))] }), _jsxs("div", { className: "mt-5 space-y-3", children: [wagers.map((wager) => (_jsxs("div", { className: "rounded-2xl border border-white/5 bg-white/5 px-4 py-3 text-sm text-white", children: [_jsxs("div", { className: "flex items-center justify-between text-xs uppercase tracking-[0.3em] text-white/50", children: [_jsx("span", { className: "capitalize", children: wager.market_type.replace(/_/g, " ") }), _jsx("span", { className: `rounded-full px-2 py-0.5 ${wager.status === "won" ? "bg-emerald-500/20 text-emerald-300" :
                                                            wager.status === "lost" ? "bg-red-500/20 text-red-300" :
                                                                wager.status === "refunded" ? "bg-yellow-500/20 text-yellow-300" :
                                                                    "bg-blue-500/20 text-blue-300"}`, children: formatStatus(wager.status) })] }), _jsxs("p", { className: "mt-2 text-base font-semibold", children: [`${currencySymbol}${wager.stake.toFixed(2)}`, " on ", wager.outcome_label] }), _jsx("p", { className: "text-xs text-white/60", children: wager.event_title }), _jsx("p", { className: "mt-1 text-xs text-white/60", children: wager.market_name }), _jsxs("div", { className: "mt-2 flex items-center justify-between", children: [_jsxs("div", { className: "text-xs text-white/60", children: [_jsxs("span", { children: ["Odds ", wager.effective_odds.toFixed(2)] }), _jsx("span", { className: "mx-1", children: "\u00B7" }), wager.status === "won" && wager.settled_payout ? (_jsxs("span", { className: "font-semibold text-emerald-300", children: ["Final Payout ", `${currencySymbol}${wager.settled_payout.toFixed(2)}`] })) : wager.status === "void_refund" && wager.settled_payout ? (_jsxs("span", { className: "font-semibold text-yellow-300", children: ["Refunded ", `${currencySymbol}${wager.settled_payout.toFixed(2)}`] })) : (_jsxs("span", { children: ["Potential ", `${currencySymbol}${wager.estimated_payout.toFixed(2)}`] }))] }), _jsx("a", { href: `/market/${wager.market_id}`, className: "text-xs font-semibold uppercase tracking-[0.3em] text-brand transition hover:text-white", children: "View \u2192" })] }), _jsx("p", { className: "mt-1 text-xs text-white/50", children: new Date(wager.created_at).toLocaleString() })] }, wager.id))), !wagers.length && !wagersQuery.isLoading && (_jsx("p", { className: "text-sm text-white/60", children: "No wagers yet. Select a market to place your first bet." }))] })] })] }), _jsxs("section", { className: "rounded-3xl border border-white/10 bg-black/20 p-6", children: [_jsxs("header", { className: "flex flex-wrap items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs uppercase tracking-[0.35em] text-white/50", children: "Requests" }), _jsx("h2", { className: "text-xl font-semibold text-white", children: "Deposit & withdrawal status" })] }), _jsx("div", { className: "text-xs text-white/50", children: "Auto-refreshes whenever an admin updates your request." })] }), _jsxs("div", { className: "mt-6 grid gap-6 lg:grid-cols-2", children: [_jsx(RequestList, { title: "Deposits", isLoading: depositsQuery.isLoading, entries: depositEntries.map((entry) => ({
                                    id: entry.id,
                                    amount: entry.amount,
                                    status: entry.status,
...
const RequestList = ({ title, entries, isLoading }) => {
    return (_jsxs("div", { className: "rounded-3xl border border-white/10 bg-white/5 p-5", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "text-lg font-semibold text-white", children: title }), isLoading && (_jsx("span", { className: "text-xs uppercase tracking-[0.3em] text-white/40", children: "Loading\u2026" }))] }), _jsxs("div", { className: "mt-4 space-y-3", children: [entries.map((entry) => (_jsxs("article", { className: "rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-sm text-white", children: [_jsxs("div", { className: "flex items-center justify-between gap-2", children: [_jsx("p", { className: "text-base font-semibold", children: `${currencySymbol}${entry.amount.toFixed(2)}` }), _jsx("span", { className: "rounded-full border border-white/20 px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-white/70", children: formatStatus(entry.status) })] }), _jsxs("p", { className: "text-xs text-white/60", children: ["Requested ", new Date(entry.requested_at).toLocaleString()] }), entry.resolved_at && (_jsxs("p", { className: "text-xs text-emerald-300", children: ["Cleared ", new Date(entry.resolved_at).toLocaleString(), entry.resolved_by && _jsxs(_Fragment, { children: [" \u00B7 by ", formatUserId(entry.resolved_by)] })] }))] }, entry.id))), !entries.length && !isLoading && (_jsxs("p", { className: "text-sm text-white/60", children: ["No ", title.toLowerCase(), " yet."] }))] })] }));
};

...
import type { MarketContainer } from "@domains/betting/api/marketAdminApi";
...
vi.mock("@domains/betting/api/marketAdminApi", async () => {
  const actual = await vi.importActual<typeof import("@domains/betting/api/marketAdminApi")>(
    "@domains/betting/api/marketAdminApi"
  );
  return {
    ...actual,
...
const marketFixtures: MarketContainer[] = [
  {
    id: "event-external",

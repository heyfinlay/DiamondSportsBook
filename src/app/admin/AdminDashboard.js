...
const AdminDashboard = () => {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("header", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm uppercase tracking-[0.3em] text-white/60", children: "Admin" }), _jsx("h1", { className: "text-3xl font-semibold", children: "Control Center" }), _jsx("p", { className: "text-sm text-white/60", children: "Manage pending deposits & withdrawals. Actions require betting_admin permissions enforced via RLS." })] }), _jsxs("div", { className: "flex flex-col items-end gap-2 sm:flex-row", children: [_jsx(Link, { to: "/admin/settlements", className: "inline-block rounded-2xl border border-white/30 px-6 py-3 text-sm font-semibold uppercase tracking-widest text-white hover:border-white/60", children: "Settlement Audit" }), _jsx(Link, { to: "/admin/championship", className: "inline-block rounded-2xl border border-white/30 px-6 py-3 text-sm font-semibold uppercase tracking-widest text-white hover:border-white/60", children: "Championship" }), _jsx(Link, { to: "/admin/timing-sessions", className: "inline-block rounded-2xl border border-white/30 px-6 py-3 text-sm font-semibold uppercase tracking-widest text-white hover:border-white/60", children: "Manage Sessions" }), _jsx(Link, { to: "/admin/session-setup", className: "inline-block rounded-2xl bg-brand px-6 py-3 text-sm font-semibold uppercase tracking-widest text-black hover:bg-brand/90", children: "+ Create Session" })] })] }), _jsxs("section", { className: "rounded-3xl border border-white/10 bg-black/40 p-6", children: [_jsx("h2", { className: "text-xl font-semibold", children: "Pending Deposits" }), depositsQuery.isLoading && (_jsx("p", { className: "text-sm text-white/60", children: "Loading\u2026" })), _jsxs("div", { className: "mt-4 space-y-3", children: [depositsQuery.data?.map((deposit) => (_jsx("article", { className: "flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3", children: (() => {
                                    ...
                                    return (_jsxs(_Fragment, { children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold", children: `${currencySymbol}${deposit.amount.toFixed(2)}` }), _jsxs("p", { className: "text-xs text-white/60", children: ["Character: ", characterName] }), _jsxs("p", { className: "text-xs text-white/60", children: ["IC #: ", icNumber] }), _jsxs("p", { className: "text-xs text-white/40", children: ["UUID: ", uuid.slice(0, 8), "\u2026 \u00B7 ", new Date(deposit.requested_at).toLocaleString()] })] }), _jsx("button", { className: "rounded-full bg-brand px-4 py-2 text-xs font-semibold uppercase tracking-widest text-black disabled:opacity-50", onClick: () => approveDepositMutation.mutate(deposit.id), disabled: approveDepositMutation.isPending, children: "Approve" })] }));
                                })() }, deposit.id))), depositsQuery.data && depositsQuery.data.length === 0 && (_jsx("p", { className: "text-sm text-white/60", children: "No pending deposits." }))] })] }), _jsxs("section", { className: "rounded-3xl border border-white/10 bg-black/40 p-6", children: [_jsx("h2", { className: "text-xl font-semibold", children: "Pending Withdrawals" }), withdrawalsQuery.isLoading && (_jsx("p", { className: "text-sm text-white/60", children: "Loading\u2026" })), _jsxs("div", { className: "mt-4 space-y-3", children: [withdrawalsQuery.data?.map((withdrawal) => (_jsxs("article", { className: "flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3", children: [(() => {
                                        ...
                                        return (_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold", children: `${currencySymbol}${withdrawal.amount.toFixed(2)}` }), _jsxs("p", { className: "text-xs text-white/60", children: ["Character: ", characterName] }), _jsxs("p", { className: "text-xs text-white/60", children: ["IC #: ", icNumber] }), _jsxs("p", { className: "text-xs text-white/40", children: ["UUID: ", uuid.slice(0, 8), "\u2026 \u00B7 ", new Date(withdrawal.requested_at).toLocaleString()] })] }));
                                    })(), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { className: "rounded-full bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-black disabled:opacity-50", onClick: () => approveWithdrawalMutation.mutate(withdrawal.id), disabled: approveWithdrawalMutation.isPending, children: "Approve" }), _jsx("button", { className: "rounded-full border border-red-400/50 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-red-300 disabled:opacity-50", onClick: () => {

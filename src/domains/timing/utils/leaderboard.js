...
const getGapMs = (driver, leader) => {
    ...
    if (isFiniteNumber(driver.gap_to_leader_ms))
        return Math.max(0, driver.gap_to_leader_ms);
    return null;
};
const formatLapDeficit = (lapDiff, gapMs) => {

...
export const getSportLabel = (sportCode?: SportCode | null) => {
  switch (sportCode) {
    case "f1":
      return "Formula 1";
    case "nrl":
...
export const getSportAccentClass = (sportCode?: SportCode | null) => {
  switch (sportCode) {
    case "mma":
      return "text-danger";
    case "soccer":
...
export const getSportSurfaceClass = (sportCode?: SportCode | null) => {
  switch (sportCode) {
    case "mma":
...
export const getSportWatermark = (sportCode?: SportCode | null) => {
  switch (sportCode) {
    case "f1":
      return "GRID";
    case "nrl":
